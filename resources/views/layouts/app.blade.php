...
<body>
    <div id="app">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Pool <span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
                <li><a href="/tournament">Toernooien</a></li>
                <li><a href="/competitions/2017">Competities</a></li>
